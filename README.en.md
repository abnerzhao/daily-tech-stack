...
A static daily briefing that collects the top 10 items from GitHub Trending, Hacker News, and Product Hunt.

## Deployment and scheduled updates

Flow: GitHub Actions fetches the three top-10 lists every day at 07:30 Asia/Shanghai, updates `index.html`, and commits the result. Vercel watches new commits on `main` and deploys them automatically. No remote server, cron job, or Vercel token is required.
